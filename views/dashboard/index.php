    ...
    <table class="table table-striped mt-5 w-75 rounded">
        <thead>
            <tr>
                ...
                <th></th>
                <th>
                    <a href="<?php echo BASE_URL ?>employee/editEmployee"><button name="addEmployee" type="submit"  class="btn btn-success" data-toggle="modal" data-target="#infoDisplay"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-plus" viewBox="0 0 16 16">
